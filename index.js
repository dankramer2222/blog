...
// Serve your index.html on the root URL
app.get('/', (req, res) => {
...
app.post('/register',async(req,res)=>{
    ...
    //Sanit and validate user input for safety our db we want remove option for users send js or sql injections
...
app.post('/posts',authenticateJWT,async(req,res)=>{
    if(req.user.role === 'admin'){
        const{
            title,content,imageUrl,author,timestamp
        } = req.body;
...
// Handle routes and API endpoints here
// For example, you might define routes for creating, retrieving, updating, and deleting posts, as well as user authentication.

// Define your routes and API endpoints here

// Start the Express server and listen on the specified port

// You can add your route handlers and other logic here
